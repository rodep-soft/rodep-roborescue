...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX2__TRAITS_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX2__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "secondary_id: ";
    rosidl_generator_traits::value_to_yaml(msg.secondary_id, out);
    out << ", ";
  }
  ...
  {
    out << "pwm_limit: ";
    rosidl_generator_traits::value_to_yaml(msg.pwm_limit, out);
    out << ", ";
  }
  ...
  {
    out << "position_d_gain: ";
    rosidl_generator_traits::value_to_yaml(msg.position_d_gain, out);
    out << ", ";
  }
  ...
  {
    out << "position_i_gain: ";
    rosidl_generator_traits::value_to_yaml(msg.position_i_gain, out);
    out << ", ";
  }
  ...
  {
    out << "feedforward_2nd_gain: ";
    rosidl_generator_traits::value_to_yaml(msg.feedforward_2nd_gain, out);
    out << ", ";
  }

  // member: feedforward_1st_gain
  {
    out << "feedforward_1st_gain: ";
    rosidl_generator_traits::value_to_yaml(msg.feedforward_1st_gain, out);
    out << ", ";
  }
  ...
  {
    out << "bus_watchdog: ";
    rosidl_generator_traits::value_to_yaml(msg.bus_watchdog, out);
    out << ", ";
  }
  ...
  {
    out << "goal_pwm: ";
    rosidl_generator_traits::value_to_yaml(msg.goal_pwm, out);
    out << ", ";
  }
  ...
  {
    out << "realtime_tick: ";
    rosidl_generator_traits::value_to_yaml(msg.realtime_tick, out);
    out << ", ";
  }
  ...
  {
    out << "present_pwm: ";
    rosidl_generator_traits::value_to_yaml(msg.present_pwm, out);
    out << ", ";
  }
  ...
  // member: velocity_trajectory
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.velocity_trajectory, out);
    out << ", ";
  }
  ...
  // member: position_trajectory
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.position_trajectory, out);
    out << ", ";
  }
...
inline std::string to_yaml(const MX2 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dynamixel_workbench_msgs::msg::MX2 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dynamixel_workbench_msgs::msg::MX2 & msg)
{
  return dynamixel_workbench_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dynamixel_workbench_msgs::msg::MX2>()
{
  return "dynamixel_workbench_msgs::msg::MX2";
}

template<>
inline const char * name<dynamixel_workbench_msgs::msg::MX2>()
{
  return "dynamixel_workbench_msgs/msg/MX2";
}

template<>
struct has_fixed_size<dynamixel_workbench_msgs::msg::MX2>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<dynamixel_workbench_msgs::msg::MX2>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<dynamixel_workbench_msgs::msg::MX2>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX2__TRAITS_HPP_
