...
#include "dynamixel_workbench_msgs/msg/detail/rx__rosidl_typesupport_fastrtps_c.h"
...
using _RX__ros_msg_type = dynamixel_workbench_msgs__msg__RX;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RX__ros_msg_type * ros_message = static_cast<const _RX__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _RX__ros_msg_type * ros_message = static_cast<_RX__ros_msg_type *>(untyped_ros_message);
  // Field name: model_number
  {
    cdr >> ros_message->model_number;
  }
...
size_t get_serialized_size_dynamixel_workbench_msgs__msg__RX(
  const void * untyped_ros_message,
...
static uint32_t _RX__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_workbench_msgs__msg__RX(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_workbench_msgs
size_t max_serialized_size_dynamixel_workbench_msgs__msg__RX(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs__msg__RX;
    is_plain =
      (
...
static size_t _RX__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynamixel_workbench_msgs__msg__RX(
...
static message_type_support_callbacks_t __callbacks_RX = {
...
static rosidl_message_type_support_t _RX__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_workbench_msgs, msg, RX)() {
  return &_RX__type_support;
}
