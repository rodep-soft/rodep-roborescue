...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__EX__TRAITS_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__EX__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "sensored_current: ";
    rosidl_generator_traits::value_to_yaml(msg.sensored_current, out);
  }
  out << "}";
...
inline std::string to_yaml(const EX & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dynamixel_workbench_msgs::msg::EX & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dynamixel_workbench_msgs::msg::EX & msg)
{
  return dynamixel_workbench_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dynamixel_workbench_msgs::msg::EX>()
{
  return "dynamixel_workbench_msgs::msg::EX";
}

template<>
inline const char * name<dynamixel_workbench_msgs::msg::EX>()
{
  return "dynamixel_workbench_msgs/msg/EX";
}

template<>
struct has_fixed_size<dynamixel_workbench_msgs::msg::EX>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<dynamixel_workbench_msgs::msg::EX>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<dynamixel_workbench_msgs::msg::EX>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__EX__TRAITS_HPP_
