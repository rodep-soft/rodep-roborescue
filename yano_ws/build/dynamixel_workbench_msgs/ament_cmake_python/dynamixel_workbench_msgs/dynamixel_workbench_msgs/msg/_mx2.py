...
class Metaclass_MX2(type):
    """Metaclass of message 'MX2'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dynamixel_workbench_msgs.msg.MX2')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mx2
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mx2
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mx2
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mx2
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mx2
...
class MX2(metaclass=Metaclass_MX2):
    """Message class 'MX2'."""
