...
#include "dynamixel_workbench_msgs/msg/detail/pro__rosidl_typesupport_fastrtps_c.h"
...
using _PRO__ros_msg_type = dynamixel_workbench_msgs__msg__PRO;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PRO__ros_msg_type * ros_message = static_cast<const _PRO__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PRO__ros_msg_type * ros_message = static_cast<_PRO__ros_msg_type *>(untyped_ros_message);
  // Field name: model_number
  {
    cdr >> ros_message->model_number;
  }
...
size_t get_serialized_size_dynamixel_workbench_msgs__msg__PRO(
  const void * untyped_ros_message,
...
static uint32_t _PRO__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_workbench_msgs__msg__PRO(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_workbench_msgs
size_t max_serialized_size_dynamixel_workbench_msgs__msg__PRO(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs__msg__PRO;
    is_plain =
      (
...
static size_t _PRO__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynamixel_workbench_msgs__msg__PRO(
...
static message_type_support_callbacks_t __callbacks_PRO = {
...
static rosidl_message_type_support_t _PRO__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_workbench_msgs, msg, PRO)() {
  return &_PRO__type_support;
}
