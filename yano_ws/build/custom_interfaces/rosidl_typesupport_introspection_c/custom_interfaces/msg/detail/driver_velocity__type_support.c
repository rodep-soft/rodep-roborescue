...
#include <stddef.h>
#include "custom_interfaces/msg/detail/driver_velocity__rosidl_typesupport_introspection_c.h"
...
void custom_interfaces__msg__DriverVelocity__rosidl_typesupport_introspection_c__DriverVelocity_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__msg__DriverVelocity__init(message_memory);
}

void custom_interfaces__msg__DriverVelocity__rosidl_typesupport_introspection_c__DriverVelocity_fini_function(void * message_memory)
{
...
static rosidl_message_type_support_t custom_interfaces__msg__DriverVelocity__rosidl_typesupport_introspection_c__DriverVelocity_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, DriverVelocity)() {
  if (!custom_interfaces__msg__DriverVelocity__rosidl_typesupport_introspection_c__DriverVelocity_message_type_support_handle.typesupport_identifier) {
    custom_interfaces__msg__DriverVelocity__rosidl_typesupport_introspection_c__DriverVelocity_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &custom_interfaces__msg__DriverVelocity__rosidl_typesupport_introspection_c__DriverVelocity_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
