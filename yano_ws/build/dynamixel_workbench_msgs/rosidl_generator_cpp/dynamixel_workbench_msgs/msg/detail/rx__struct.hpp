...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__RX__STRUCT_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__RX__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dynamixel_workbench_msgs__msg__RX __attribute__((deprecated))
#else
# define DEPRECATED__dynamixel_workbench_msgs__msg__RX __declspec(deprecated)
#endif
...
struct RX_
{
  using Type = RX_<ContainerAllocator>;

  explicit RX_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RX_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    dynamixel_workbench_msgs::msg::RX_<ContainerAllocator> *;
  using ConstRawPtr =
    const dynamixel_workbench_msgs::msg::RX_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dynamixel_workbench_msgs::msg::RX_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__RX
    std::shared_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__RX
    std::shared_ptr<dynamixel_workbench_msgs::msg::RX_<ContainerAllocator> const>
  ...
  bool operator==(const RX_ & other) const
  {
...
using RX =
  dynamixel_workbench_msgs::msg::RX_<std::allocator<void>>;
...
#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__RX__STRUCT_HPP_
