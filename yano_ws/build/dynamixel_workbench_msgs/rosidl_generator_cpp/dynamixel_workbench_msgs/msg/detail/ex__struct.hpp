...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__EX__STRUCT_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__EX__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dynamixel_workbench_msgs__msg__EX __attribute__((deprecated))
#else
# define DEPRECATED__dynamixel_workbench_msgs__msg__EX __declspec(deprecated)
#endif
...
struct EX_
{
  using Type = EX_<ContainerAllocator>;

  explicit EX_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EX_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  Type & set__cw_compliance_margin(
    const uint8_t & _arg)
  {
    this->cw_compliance_margin = _arg;
    return *this;
  }
  Type & set__ccw_compliance_margin(
    const uint8_t & _arg)
  {
    this->ccw_compliance_margin = _arg;
    return *this;
  }
  Type & set__cw_compliance_slope(
    const uint8_t & _arg)
  {
    this->cw_compliance_slope = _arg;
    return *this;
  }
  Type & set__ccw_compliance_slope(
    const uint8_t & _arg)
  {
    this->ccw_compliance_slope = _arg;
    return *this;
  }
  ...
  Type & set__sensored_current(
    const uint16_t & _arg)
  {
    this->sensored_current = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    dynamixel_workbench_msgs::msg::EX_<ContainerAllocator> *;
  using ConstRawPtr =
    const dynamixel_workbench_msgs::msg::EX_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dynamixel_workbench_msgs::msg::EX_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__EX
    std::shared_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__EX
    std::shared_ptr<dynamixel_workbench_msgs::msg::EX_<ContainerAllocator> const>
  ...
  bool operator==(const EX_ & other) const
  {
    ...
    if (this->alarm_led != other.alarm_led) {
      return false;
    }
    ...
    if (this->cw_compliance_margin != other.cw_compliance_margin) {
      return false;
    }
    if (this->ccw_compliance_margin != other.ccw_compliance_margin) {
      return false;
    }
    if (this->cw_compliance_slope != other.cw_compliance_slope) {
      return false;
    }
    if (this->ccw_compliance_slope != other.ccw_compliance_slope) {
      return false;
    }
    ...
    if (this->sensored_current != other.sensored_current) {
      return false;
    }
    return true;
  }
...
using EX =
  dynamixel_workbench_msgs::msg::EX_<std::allocator<void>>;
...
#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__EX__STRUCT_HPP_
