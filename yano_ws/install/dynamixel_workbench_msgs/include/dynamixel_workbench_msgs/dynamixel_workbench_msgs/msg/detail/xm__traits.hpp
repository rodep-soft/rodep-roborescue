...
inline std::string to_yaml(const XM & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dynamixel_workbench_msgs::msg::XM & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dynamixel_workbench_msgs::msg::XM & msg)
{
