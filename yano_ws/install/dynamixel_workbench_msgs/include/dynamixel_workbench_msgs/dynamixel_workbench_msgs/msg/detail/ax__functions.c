...
bool
dynamixel_workbench_msgs__msg__AX__init(dynamixel_workbench_msgs__msg__AX * msg)
{
  if (!msg) {
    return false;
  }
...
void
dynamixel_workbench_msgs__msg__AX__fini(dynamixel_workbench_msgs__msg__AX * msg)
{
  if (!msg) {
    return;
  }
...
bool
dynamixel_workbench_msgs__msg__AX__are_equal(const dynamixel_workbench_msgs__msg__AX * lhs, const dynamixel_workbench_msgs__msg__AX * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
dynamixel_workbench_msgs__msg__AX__copy(
  const dynamixel_workbench_msgs__msg__AX * input,
  dynamixel_workbench_msgs__msg__AX * output)
{
  if (!input || !output) {
    return false;
  }
...
dynamixel_workbench_msgs__msg__AX__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_workbench_msgs__msg__AX * msg = (dynamixel_workbench_msgs__msg__AX *)allocator.allocate(sizeof(dynamixel_workbench_msgs__msg__AX), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_workbench_msgs__msg__AX));
  bool success = dynamixel_workbench_msgs__msg__AX__init(msg);
  if (!success) {
...
void
dynamixel_workbench_msgs__msg__AX__destroy(dynamixel_workbench_msgs__msg__AX * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dynamixel_workbench_msgs__msg__AX__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bool
dynamixel_workbench_msgs__msg__AX__Sequence__init(dynamixel_workbench_msgs__msg__AX__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_workbench_msgs__msg__AX * data = NULL;

  if (size) {
    data = (dynamixel_workbench_msgs__msg__AX *)allocator.zero_allocate(size, sizeof(dynamixel_workbench_msgs__msg__AX), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_workbench_msgs__msg__AX__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dynamixel_workbench_msgs__msg__AX__fini(&data[i - 1]);
      }
...
void
dynamixel_workbench_msgs__msg__AX__Sequence__fini(dynamixel_workbench_msgs__msg__AX__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_workbench_msgs__msg__AX__fini(&array->data[i]);
    }
...
dynamixel_workbench_msgs__msg__AX__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_workbench_msgs__msg__AX__Sequence * array = (dynamixel_workbench_msgs__msg__AX__Sequence *)allocator.allocate(sizeof(dynamixel_workbench_msgs__msg__AX__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_workbench_msgs__msg__AX__Sequence__init(array, size);
  if (!success) {
...
void
dynamixel_workbench_msgs__msg__AX__Sequence__destroy(dynamixel_workbench_msgs__msg__AX__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_workbench_msgs__msg__AX__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
dynamixel_workbench_msgs__msg__AX__Sequence__are_equal(const dynamixel_workbench_msgs__msg__AX__Sequence * lhs, const dynamixel_workbench_msgs__msg__AX__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_workbench_msgs__msg__AX__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
dynamixel_workbench_msgs__msg__AX__Sequence__copy(
  const dynamixel_workbench_msgs__msg__AX__Sequence * input,
  dynamixel_workbench_msgs__msg__AX__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_workbench_msgs__msg__AX);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_workbench_msgs__msg__AX * data =
      (dynamixel_workbench_msgs__msg__AX *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_workbench_msgs__msg__AX__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_workbench_msgs__msg__AX__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_workbench_msgs__msg__AX__copy(
