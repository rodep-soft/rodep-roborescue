...
#include "dynamixel_workbench_msgs/msg/detail/pro_ext__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_workbench_msgs::msg::PROExt & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_workbench_msgs::msg::PROExt & ros_message)
{
  // Member: model_number
  cdr >> ros_message.model_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs::msg::PROExt;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::PROExt *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_workbench_msgs::msg::PROExt *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PROExt__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::PROExt *>(
...
static size_t _PROExt__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PROExt(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PROExt__callbacks = {
...
static rosidl_message_type_support_t _PROExt__handle = {
...
{
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_PROExt__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_workbench_msgs, msg, PROExt)() {
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_PROExt__handle;
}
