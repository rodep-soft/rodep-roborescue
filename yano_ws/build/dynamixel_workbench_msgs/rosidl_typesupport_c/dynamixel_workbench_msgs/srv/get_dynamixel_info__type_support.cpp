...
static const _GetDynamixelInfo_Request_type_support_symbol_names_t _GetDynamixelInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Request)() {
  return &::dynamixel_workbench_msgs::srv::rosidl_typesupport_c::GetDynamixelInfo_Request_message_type_support_handle;
}
...
static const _GetDynamixelInfo_Response_type_support_symbol_names_t _GetDynamixelInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo_Response)() {
  return &::dynamixel_workbench_msgs::srv::rosidl_typesupport_c::GetDynamixelInfo_Response_message_type_support_handle;
}
...
static const _GetDynamixelInfo_type_support_symbol_names_t _GetDynamixelInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dynamixel_workbench_msgs, srv, GetDynamixelInfo)() {
  return &::dynamixel_workbench_msgs::srv::rosidl_typesupport_c::GetDynamixelInfo_service_type_support_handle;
}
