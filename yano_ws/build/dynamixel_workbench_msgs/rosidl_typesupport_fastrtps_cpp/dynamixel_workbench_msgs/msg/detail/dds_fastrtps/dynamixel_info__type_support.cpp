...
#include "dynamixel_workbench_msgs/msg/detail/dynamixel_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const dynamixel_workbench_msgs::msg::DynamixelLoadInfo &,
...
cdr_serialize(
  const dynamixel_workbench_msgs::msg::DynamixelInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: load_info
  dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.load_info,
    cdr);
  // Member: model_name
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_workbench_msgs::msg::DynamixelInfo & ros_message)
{
  // Member: load_info
  ...
  size_t current_alignment)
{
  ...
  // Member: load_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DynamixelLoadInfo(
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs::msg::DynamixelInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::DynamixelInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_workbench_msgs::msg::DynamixelInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DynamixelInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::DynamixelInfo *>(
...
static size_t _DynamixelInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DynamixelInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DynamixelInfo__callbacks = {
...
static rosidl_message_type_support_t _DynamixelInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DynamixelInfo__callbacks,
...
{
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_DynamixelInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_workbench_msgs, msg, DynamixelInfo)() {
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_DynamixelInfo__handle;
}
