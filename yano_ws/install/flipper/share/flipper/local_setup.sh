...
: ${AMENT_CURRENT_PREFIX:="/root/working/test_ws/yano_ws/install/flipper"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/flipper/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/flipper/environment/path.sh"
