...
bool dynamixel_workbench_msgs__msg__xl320__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_workbench_msgs.msg._xl320.XL320", full_classname_dest, 41) == 0);
  }
  dynamixel_workbench_msgs__msg__XL320 * ros_message = _ros_message;
  {  // model_number
...
{
  /* NOTE(esteve): Call constructor of XL320 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_workbench_msgs.msg._xl320");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "XL320");
