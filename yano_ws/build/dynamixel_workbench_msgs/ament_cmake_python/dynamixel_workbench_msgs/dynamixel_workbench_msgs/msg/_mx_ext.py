...
class Metaclass_MXExt(type):
    """Metaclass of message 'MXExt'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dynamixel_workbench_msgs.msg.MXExt')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mx_ext
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mx_ext
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mx_ext
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mx_ext
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mx_ext
...
class MXExt(metaclass=Metaclass_MXExt):
    """Message class 'MXExt'."""
    ...
    _fields_and_field_types = {
        ...
        'alarm_led': 'uint8',
        'shutdown': 'uint8',
        'multi_turn_offset': 'uint16',
        'resolution_divider': 'uint8',
        'torque_enable': 'uint8',
        'led': 'uint8',
        'd_gain': 'uint8',
        'i_gain': 'uint8',
        ...
        'punch': 'uint16',
        'current': 'uint16',
        'torque_control_mode_enable': 'uint8',
        'goal_torque': 'uint16',
        'goal_acceleration': 'uint8',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.multi_turn_offset = kwargs.get('multi_turn_offset', int())
        self.resolution_divider = kwargs.get('resolution_divider', int())
        ...
        self.torque_control_mode_enable = kwargs.get('torque_control_mode_enable', int())
    ...
    def __eq__(self, other):
        ...
        if self.shutdown != other.shutdown:
            return False
        if self.multi_turn_offset != other.multi_turn_offset:
            return False
        if self.resolution_divider != other.resolution_divider:
            return False
        ...
        if self.current != other.current:
            return False
        if self.torque_control_mode_enable != other.torque_control_mode_enable:
            return False
    ...
    def multi_turn_offset(self):
        """Message field 'multi_turn_offset'."""
        return self._multi_turn_offset

    @multi_turn_offset.setter
    def multi_turn_offset(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'multi_turn_offset' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'multi_turn_offset' field must be an unsigned integer in [0, 65535]"
        self._multi_turn_offset = value

    @builtins.property
    def resolution_divider(self):
        """Message field 'resolution_divider'."""
    ...
    def resolution_divider(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'resolution_divider' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'resolution_divider' field must be an unsigned integer in [0, 255]"
    ...
    def d_gain(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'd_gain' field must be an unsigned integer in [0, 255]"
        self._d_gain = value
    ...
    def i_gain(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'i_gain' field must be an unsigned integer in [0, 255]"
        self._i_gain = value
    ...
    def p_gain(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'p_gain' field must be an unsigned integer in [0, 255]"
        self._p_gain = value
    ...
    def torque_control_mode_enable(self):
        """Message field 'torque_control_mode_enable'."""
        return self._torque_control_mode_enable

    @torque_control_mode_enable.setter
    def torque_control_mode_enable(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'torque_control_mode_enable' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'torque_control_mode_enable' field must be an unsigned integer in [0, 255]"
        self._torque_control_mode_enable = value
    ...
    def goal_acceleration(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'goal_acceleration' field must be an unsigned integer in [0, 255]"
