...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__XL__STRUCT_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__XL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dynamixel_workbench_msgs__msg__XL __attribute__((deprecated))
#else
# define DEPRECATED__dynamixel_workbench_msgs__msg__XL __declspec(deprecated)
#endif
...
struct XL_
{
  using Type = XL_<ContainerAllocator>;

  explicit XL_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit XL_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    dynamixel_workbench_msgs::msg::XL_<ContainerAllocator> *;
  using ConstRawPtr =
    const dynamixel_workbench_msgs::msg::XL_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dynamixel_workbench_msgs::msg::XL_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__XL
    std::shared_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__XL
    std::shared_ptr<dynamixel_workbench_msgs::msg::XL_<ContainerAllocator> const>
  ...
  bool operator==(const XL_ & other) const
  {
...
using XL =
  dynamixel_workbench_msgs::msg::XL_<std::allocator<void>>;
...
#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__XL__STRUCT_HPP_
