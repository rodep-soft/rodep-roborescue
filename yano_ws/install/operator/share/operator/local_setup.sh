...
: ${AMENT_CURRENT_PREFIX:="/home/rodep/rodep/test_ws/yano_ws/install/operator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/operator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/operator/environment/path.sh"
