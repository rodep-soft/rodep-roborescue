...
#include "dynamixel_workbench_msgs/msg/detail/ex__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_workbench_msgs::msg::EX & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_workbench_msgs::msg::EX & ros_message)
{
  // Member: model_number
  cdr >> ros_message.model_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs::msg::EX;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::EX *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_workbench_msgs::msg::EX *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EX__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::EX *>(
...
static size_t _EX__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EX(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EX__callbacks = {
...
static rosidl_message_type_support_t _EX__handle = {
...
{
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_EX__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_workbench_msgs, msg, EX)() {
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_EX__handle;
}
