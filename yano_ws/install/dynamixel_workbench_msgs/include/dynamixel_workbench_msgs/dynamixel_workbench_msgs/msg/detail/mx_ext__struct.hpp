...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX_EXT__STRUCT_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX_EXT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__dynamixel_workbench_msgs__msg__MXExt __attribute__((deprecated))
#else
# define DEPRECATED__dynamixel_workbench_msgs__msg__MXExt __declspec(deprecated)
#endif
...
struct MXExt_
{
  using Type = MXExt_<ContainerAllocator>;

  explicit MXExt_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit MXExt_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using _multi_turn_offset_type =
    uint16_t;
  _multi_turn_offset_type multi_turn_offset;
  using _resolution_divider_type =
    uint8_t;
  ...
  using _torque_control_mode_enable_type =
    uint8_t;
  ...
  Type & set__multi_turn_offset(
    const uint16_t & _arg)
  {
    this->multi_turn_offset = _arg;
    return *this;
  }
  Type & set__resolution_divider(
    const uint8_t & _arg)
  {
    this->resolution_divider = _arg;
    return *this;
  }
  ...
  Type & set__torque_control_mode_enable(
    const uint8_t & _arg)
  {
    this->torque_control_mode_enable = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator> *;
  using ConstRawPtr =
    const dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__MXExt
    std::shared_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dynamixel_workbench_msgs__msg__MXExt
    std::shared_ptr<dynamixel_workbench_msgs::msg::MXExt_<ContainerAllocator> const>
  ...
  bool operator==(const MXExt_ & other) const
  {
    ...
    if (this->multi_turn_offset != other.multi_turn_offset) {
      return false;
    }
    if (this->resolution_divider != other.resolution_divider) {
      return false;
    }
    ...
    if (this->torque_control_mode_enable != other.torque_control_mode_enable) {
      return false;
    }
...
using MXExt =
  dynamixel_workbench_msgs::msg::MXExt_<std::allocator<void>>;
...
#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX_EXT__STRUCT_HPP_
