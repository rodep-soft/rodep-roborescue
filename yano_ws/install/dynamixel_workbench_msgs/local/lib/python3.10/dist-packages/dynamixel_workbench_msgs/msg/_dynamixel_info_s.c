...
bool dynamixel_workbench_msgs__msg__dynamixel_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_workbench_msgs.msg._dynamixel_info.DynamixelInfo", full_classname_dest, 58) == 0);
  }
  dynamixel_workbench_msgs__msg__DynamixelInfo * ros_message = _ros_message;
  {  // load_info
    PyObject * field = PyObject_GetAttrString(_pymsg, "load_info");
    if (!field) {
      return false;
    }
    if (!dynamixel_workbench_msgs__msg__dynamixel_load_info__convert_from_py(field, &ros_message->load_info)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of DynamixelInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_workbench_msgs.msg._dynamixel_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamixelInfo");
  ...
  {  // load_info
    PyObject * field = NULL;
    field = dynamixel_workbench_msgs__msg__dynamixel_load_info__convert_to_py(&ros_message->load_info);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "load_info", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
