...
#include "dynamixel_workbench_msgs/msg/detail/mx2__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_workbench_msgs::msg::MX2 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_workbench_msgs::msg::MX2 & ros_message)
{
  // Member: model_number
  cdr >> ros_message.model_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs::msg::MX2;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::MX2 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_workbench_msgs::msg::MX2 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MX2__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::MX2 *>(
...
static size_t _MX2__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MX2(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MX2__callbacks = {
...
static rosidl_message_type_support_t _MX2__handle = {
...
{
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_MX2__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_workbench_msgs, msg, MX2)() {
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_MX2__handle;
}
