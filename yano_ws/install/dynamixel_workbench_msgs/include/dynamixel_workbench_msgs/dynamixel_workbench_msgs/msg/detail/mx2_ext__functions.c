...
dynamixel_workbench_msgs__msg__MX2Ext__create()
{
  ...
  dynamixel_workbench_msgs__msg__MX2Ext * msg = (dynamixel_workbench_msgs__msg__MX2Ext *)allocator.allocate(sizeof(dynamixel_workbench_msgs__msg__MX2Ext), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_workbench_msgs__msg__MX2Ext));
  bool success = dynamixel_workbench_msgs__msg__MX2Ext__init(msg);
  if (!success) {
...
dynamixel_workbench_msgs__msg__MX2Ext__destroy(dynamixel_workbench_msgs__msg__MX2Ext * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dynamixel_workbench_msgs__msg__MX2Ext__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dynamixel_workbench_msgs__msg__MX2Ext__Sequence__init(dynamixel_workbench_msgs__msg__MX2Ext__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_workbench_msgs__msg__MX2Ext * data = NULL;

  if (size) {
    data = (dynamixel_workbench_msgs__msg__MX2Ext *)allocator.zero_allocate(size, sizeof(dynamixel_workbench_msgs__msg__MX2Ext), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_workbench_msgs__msg__MX2Ext__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dynamixel_workbench_msgs__msg__MX2Ext__fini(&data[i - 1]);
      }
...
dynamixel_workbench_msgs__msg__MX2Ext__Sequence__fini(dynamixel_workbench_msgs__msg__MX2Ext__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_workbench_msgs__msg__MX2Ext__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_workbench_msgs__msg__MX2Ext__Sequence * array = (dynamixel_workbench_msgs__msg__MX2Ext__Sequence *)allocator.allocate(sizeof(dynamixel_workbench_msgs__msg__MX2Ext__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_workbench_msgs__msg__MX2Ext__Sequence__init(array, size);
  if (!success) {
...
dynamixel_workbench_msgs__msg__MX2Ext__Sequence__destroy(dynamixel_workbench_msgs__msg__MX2Ext__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_workbench_msgs__msg__MX2Ext__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dynamixel_workbench_msgs__msg__MX2Ext__Sequence__are_equal(const dynamixel_workbench_msgs__msg__MX2Ext__Sequence * lhs, const dynamixel_workbench_msgs__msg__MX2Ext__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_workbench_msgs__msg__MX2Ext__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dynamixel_workbench_msgs__msg__MX2Ext__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_workbench_msgs__msg__MX2Ext);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_workbench_msgs__msg__MX2Ext * data =
      (dynamixel_workbench_msgs__msg__MX2Ext *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_workbench_msgs__msg__MX2Ext__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_workbench_msgs__msg__MX2Ext__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_workbench_msgs__msg__MX2Ext__copy(
