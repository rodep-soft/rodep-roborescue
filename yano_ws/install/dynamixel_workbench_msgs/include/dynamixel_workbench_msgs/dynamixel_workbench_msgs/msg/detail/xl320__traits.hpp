...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__XL320__TRAITS_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__XL320__TRAITS_HPP_
...
inline std::string to_yaml(const XL320 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dynamixel_workbench_msgs::msg::XL320 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dynamixel_workbench_msgs::msg::XL320 & msg)
{
  return dynamixel_workbench_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dynamixel_workbench_msgs::msg::XL320>()
{
  return "dynamixel_workbench_msgs::msg::XL320";
}

template<>
inline const char * name<dynamixel_workbench_msgs::msg::XL320>()
{
  return "dynamixel_workbench_msgs/msg/XL320";
}

template<>
struct has_fixed_size<dynamixel_workbench_msgs::msg::XL320>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<dynamixel_workbench_msgs::msg::XL320>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<dynamixel_workbench_msgs::msg::XL320>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__XL320__TRAITS_HPP_
