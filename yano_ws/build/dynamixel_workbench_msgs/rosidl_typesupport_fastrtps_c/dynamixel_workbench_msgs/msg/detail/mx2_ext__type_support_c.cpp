...
#include "dynamixel_workbench_msgs/msg/detail/mx2_ext__rosidl_typesupport_fastrtps_c.h"
...
using _MX2Ext__ros_msg_type = dynamixel_workbench_msgs__msg__MX2Ext;

static bool _MX2Ext__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MX2Ext__ros_msg_type * ros_message = static_cast<const _MX2Ext__ros_msg_type *>(untyped_ros_message);
...
static bool _MX2Ext__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MX2Ext__ros_msg_type * ros_message = static_cast<_MX2Ext__ros_msg_type *>(untyped_ros_message);
  // Field name: model_number
  {
    cdr >> ros_message->model_number;
  }
...
size_t get_serialized_size_dynamixel_workbench_msgs__msg__MX2Ext(
  const void * untyped_ros_message,
...
static uint32_t _MX2Ext__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_workbench_msgs__msg__MX2Ext(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_workbench_msgs
size_t max_serialized_size_dynamixel_workbench_msgs__msg__MX2Ext(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs__msg__MX2Ext;
    is_plain =
      (
...
static size_t _MX2Ext__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_dynamixel_workbench_msgs__msg__MX2Ext(
...
static message_type_support_callbacks_t __callbacks_MX2Ext = {
  "dynamixel_workbench_msgs::msg",
  "MX2Ext",
  _MX2Ext__cdr_serialize,
  _MX2Ext__cdr_deserialize,
  _MX2Ext__get_serialized_size,
  _MX2Ext__max_serialized_size
};

static rosidl_message_type_support_t _MX2Ext__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_workbench_msgs, msg, MX2Ext)() {
  return &_MX2Ext__type_support;
}
