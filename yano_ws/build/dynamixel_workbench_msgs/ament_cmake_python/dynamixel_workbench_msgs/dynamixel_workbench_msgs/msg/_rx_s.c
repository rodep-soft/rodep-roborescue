...
bool dynamixel_workbench_msgs__msg__rx__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_workbench_msgs.msg._rx.RX", full_classname_dest, 35) == 0);
  }
  dynamixel_workbench_msgs__msg__RX * ros_message = _ros_message;
  {  // model_number
...
{
  /* NOTE(esteve): Call constructor of RX */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_workbench_msgs.msg._rx");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RX");
