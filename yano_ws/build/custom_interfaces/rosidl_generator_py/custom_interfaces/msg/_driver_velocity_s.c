...
bool custom_interfaces__msg__driver_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // flipper_vel
    PyObject * field = PyObject_GetAttrString(_pymsg, "flipper_vel");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'flipper_vel'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of DriverVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._driver_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DriverVelocity");
  ...
  {  // flipper_vel
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "flipper_vel");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->flipper_vel.size > 0) {
