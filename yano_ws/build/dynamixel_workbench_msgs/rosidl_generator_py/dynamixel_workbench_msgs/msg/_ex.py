...
class Metaclass_EX(type):
    """Metaclass of message 'EX'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dynamixel_workbench_msgs.msg.EX')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ex
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ex
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ex
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ex
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ex
...
class EX(metaclass=Metaclass_EX):
    """Message class 'EX'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.sensored_current = kwargs.get('sensored_current', int())
    ...
    def __eq__(self, other):
        ...
        if self.punch != other.punch:
            return False
        if self.sensored_current != other.sensored_current:
            return False
        return True
    ...
    @builtins.property
    def sensored_current(self):
        """Message field 'sensored_current'."""
        return self._sensored_current

    @sensored_current.setter
    def sensored_current(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'sensored_current' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'sensored_current' field must be an unsigned integer in [0, 65535]"
        self._sensored_current = value
