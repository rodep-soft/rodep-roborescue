...
static const _DynamixelState_type_support_symbol_names_t _DynamixelState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_workbench_msgs, msg, DynamixelState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_workbench_msgs, msg, DynamixelState)),
  }
};
...
{
  return &::dynamixel_workbench_msgs::msg::rosidl_typesupport_cpp::DynamixelState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_workbench_msgs, msg, DynamixelState)() {
  return get_message_type_support_handle<dynamixel_workbench_msgs::msg::DynamixelState>();
}
