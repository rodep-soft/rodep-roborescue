...
#ifndef DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX2_EXT__TRAITS_HPP_
#define DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX2_EXT__TRAITS_HPP_
...
inline std::string to_yaml(const MX2Ext & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dynamixel_workbench_msgs::msg::MX2Ext & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dynamixel_workbench_msgs::msg::MX2Ext & msg)
{
  return dynamixel_workbench_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dynamixel_workbench_msgs::msg::MX2Ext>()
{
  return "dynamixel_workbench_msgs::msg::MX2Ext";
}

template<>
inline const char * name<dynamixel_workbench_msgs::msg::MX2Ext>()
{
  return "dynamixel_workbench_msgs/msg/MX2Ext";
}

template<>
struct has_fixed_size<dynamixel_workbench_msgs::msg::MX2Ext>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<dynamixel_workbench_msgs::msg::MX2Ext>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<dynamixel_workbench_msgs::msg::MX2Ext>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DYNAMIXEL_WORKBENCH_MSGS__MSG__DETAIL__MX2_EXT__TRAITS_HPP_
