  ...
  std::ostream & out)
{
  ...
  {
    out << "multi_turn_offset: ";
    rosidl_generator_traits::value_to_yaml(msg.multi_turn_offset, out);
    out << ", ";
  }

  // member: resolution_divider
  {
    out << "resolution_divider: ";
    rosidl_generator_traits::value_to_yaml(msg.resolution_divider, out);
    out << ", ";
  }
  ...
  {
    out << "torque_control_mode_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.torque_control_mode_enable, out);
    out << ", ";
  }
...
inline std::string to_yaml(const MXExt & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const dynamixel_workbench_msgs::msg::MXExt & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dynamixel_workbench_msgs::msg::MXExt & msg)
{
