...
#include "dynamixel_workbench_msgs/msg/detail/dynamixel_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_workbench_msgs::msg::DynamixelState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_workbench_msgs::msg::DynamixelState & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_workbench_msgs::msg::DynamixelState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_workbench_msgs::msg::DynamixelState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_workbench_msgs::msg::DynamixelState *>(
    untyped_ros_message);
...
{
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_DynamixelState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_workbench_msgs, msg, DynamixelState)() {
  return &dynamixel_workbench_msgs::msg::typesupport_fastrtps_cpp::_DynamixelState__handle;
}
