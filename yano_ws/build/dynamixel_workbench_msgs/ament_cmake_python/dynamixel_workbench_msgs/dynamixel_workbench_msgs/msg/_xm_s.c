...
bool dynamixel_workbench_msgs__msg__xm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_workbench_msgs.msg._xm.XM", full_classname_dest, 35) == 0);
  }
  dynamixel_workbench_msgs__msg__XM * ros_message = _ros_message;
  {  // model_number
  ...
  {  // present_load
    ...
    assert(PyLong_Check(field));
    ros_message->present_load = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // present_current
...
{
  /* NOTE(esteve): Call constructor of XM */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_workbench_msgs.msg._xm");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "XM");
  ...
  {  // present_load
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->present_load);
    {
