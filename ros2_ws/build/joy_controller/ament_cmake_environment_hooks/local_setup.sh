...
: ${AMENT_CURRENT_PREFIX:="/root/working/ros2_ws/install/joy_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joy_controller/environment/pythonpath.sh"
