...
bool dynamixel_workbench_msgs__msg__pro_ext__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_workbench_msgs.msg._pro_ext.PROExt", full_classname_dest, 44) == 0);
  }
  dynamixel_workbench_msgs__msg__PROExt * ros_message = _ros_message;
  {  // model_number
...
{
  /* NOTE(esteve): Call constructor of PROExt */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_workbench_msgs.msg._pro_ext");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PROExt");
