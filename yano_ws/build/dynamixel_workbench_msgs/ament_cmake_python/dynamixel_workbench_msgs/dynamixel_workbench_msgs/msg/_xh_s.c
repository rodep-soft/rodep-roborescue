...
bool dynamixel_workbench_msgs__msg__xh__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_workbench_msgs.msg._xh.XH", full_classname_dest, 35) == 0);
  }
  dynamixel_workbench_msgs__msg__XH * ros_message = _ros_message;
  {  // model_number
  ...
  {  // secondary_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "secondary_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->secondary_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // protocol_version
  ...
  {  // homing_offset
    PyObject * field = PyObject_GetAttrString(_pymsg, "homing_offset");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->homing_offset = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // moving_threshold
  ...
  {  // pwm_limit
    PyObject * field = PyObject_GetAttrString(_pymsg, "pwm_limit");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->pwm_limit = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // current_limit
    ...
    assert(PyLong_Check(field));
    ros_message->current_limit = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // acceleration_limit
  ...
  {  // max_position_limit
    ...
    assert(PyLong_Check(field));
    ros_message->max_position_limit = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // min_position_limit
    ...
    assert(PyLong_Check(field));
    ros_message->min_position_limit = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // shutdown
  ...
  {  // position_d_gain
    PyObject * field = PyObject_GetAttrString(_pymsg, "position_d_gain");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->position_d_gain = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // position_i_gain
    PyObject * field = PyObject_GetAttrString(_pymsg, "position_i_gain");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->position_i_gain = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // position_p_gain
  ...
  {  // feedforward_2nd_gain
    PyObject * field = PyObject_GetAttrString(_pymsg, "feedforward_2nd_gain");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->feedforward_2nd_gain = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // feedforward_1st_gain
    PyObject * field = PyObject_GetAttrString(_pymsg, "feedforward_1st_gain");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->feedforward_1st_gain = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bus_watchdog
    PyObject * field = PyObject_GetAttrString(_pymsg, "bus_watchdog");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bus_watchdog = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // goal_pwm
    PyObject * field = PyObject_GetAttrString(_pymsg, "goal_pwm");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->goal_pwm = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // goal_current
    ...
    assert(PyLong_Check(field));
    ros_message->goal_current = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // goal_velocity
    ...
    assert(PyLong_Check(field));
    ros_message->goal_velocity = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // profile_acceleration
    ...
    assert(PyLong_Check(field));
    ros_message->profile_acceleration = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // profile_velocity
    ...
    assert(PyLong_Check(field));
    ros_message->profile_velocity = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // goal_position
    ...
    assert(PyLong_Check(field));
    ros_message->goal_position = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // realtime_tick
    PyObject * field = PyObject_GetAttrString(_pymsg, "realtime_tick");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->realtime_tick = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // moving
  ...
  {  // moving_status
    ...
    assert(PyLong_Check(field));
    ros_message->moving_status = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // present_pwm
    PyObject * field = PyObject_GetAttrString(_pymsg, "present_pwm");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->present_pwm = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // present_current
    ...
    assert(PyLong_Check(field));
    ros_message->present_current = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // present_velocity
    ...
    assert(PyLong_Check(field));
    ros_message->present_velocity = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // present_position
  ...
  {  // velocity_trajectory
    PyObject * field = PyObject_GetAttrString(_pymsg, "velocity_trajectory");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->velocity_trajectory = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // position_trajectory
    PyObject * field = PyObject_GetAttrString(_pymsg, "position_trajectory");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->position_trajectory = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of XH */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_workbench_msgs.msg._xh");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "XH");
  ...
  {  // secondary_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->secondary_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "secondary_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // homing_offset
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->homing_offset);
    {
      int rc = PyObject_SetAttrString(_pymessage, "homing_offset", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pwm_limit
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pwm_limit);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pwm_limit", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // current_limit
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->current_limit);
    {
  ...
  {  // max_position_limit
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->max_position_limit);
    {
  ...
  {  // min_position_limit
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->min_position_limit);
    {
  ...
  {  // position_d_gain
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->position_d_gain);
    {
      int rc = PyObject_SetAttrString(_pymessage, "position_d_gain", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // position_i_gain
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->position_i_gain);
    {
      int rc = PyObject_SetAttrString(_pymessage, "position_i_gain", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // feedforward_2nd_gain
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->feedforward_2nd_gain);
    {
      int rc = PyObject_SetAttrString(_pymessage, "feedforward_2nd_gain", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // feedforward_1st_gain
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->feedforward_1st_gain);
    {
      int rc = PyObject_SetAttrString(_pymessage, "feedforward_1st_gain", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bus_watchdog
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bus_watchdog);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bus_watchdog", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // goal_pwm
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->goal_pwm);
    {
      int rc = PyObject_SetAttrString(_pymessage, "goal_pwm", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // goal_current
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->goal_current);
    {
  ...
  {  // goal_velocity
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->goal_velocity);
    {
  ...
  {  // profile_acceleration
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->profile_acceleration);
    {
  ...
  {  // profile_velocity
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->profile_velocity);
    {
  ...
  {  // realtime_tick
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->realtime_tick);
    {
      int rc = PyObject_SetAttrString(_pymessage, "realtime_tick", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // moving_status
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->moving_status);
    {
  ...
  {  // present_pwm
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->present_pwm);
    {
      int rc = PyObject_SetAttrString(_pymessage, "present_pwm", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // present_current
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->present_current);
    {
  ...
  {  // present_velocity
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->present_velocity);
    {
  ...
  {  // velocity_trajectory
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->velocity_trajectory);
    {
      int rc = PyObject_SetAttrString(_pymessage, "velocity_trajectory", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // position_trajectory
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->position_trajectory);
    {
      int rc = PyObject_SetAttrString(_pymessage, "position_trajectory", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
