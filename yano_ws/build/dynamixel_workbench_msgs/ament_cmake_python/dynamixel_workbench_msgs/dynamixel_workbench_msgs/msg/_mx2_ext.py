...
class Metaclass_MX2Ext(type):
    """Metaclass of message 'MX2Ext'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dynamixel_workbench_msgs.msg.MX2Ext')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mx2_ext
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mx2_ext
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mx2_ext
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mx2_ext
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mx2_ext
...
class MX2Ext(metaclass=Metaclass_MX2Ext):
    """Message class 'MX2Ext'."""
